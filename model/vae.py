...
class DETRVAE(nn.Module):
    def __init__(
        ...
        self.register_buffer('pos_table', get_sinusoid_encoding_table(1 + 1 + num_actions, hidden_dim))  # [CLS], qpos, a_seq
    ...
    def forward(self, qpos, image, env_state=None, actions=None, is_pad=None):
        ...
        if is_training:  # obtain latent z from action sequence
            ...
            cls_joint_is_pad = torch.full((bs, 2), False).to(qpos.device)  # cls and qpos are not a padding
