...
def build_backbone(cfg):
    position_embedding = build_position_encoding(cfg.positional_encoding.hidden_dim, cfg.positional_encoding.type)
    backbone = Backbone(
        name=cfg.type,
        train_backbone=cfg.train_backbone,
        return_interm_layers=cfg.return_interm_layers,
